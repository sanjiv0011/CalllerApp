...
import com.dialer.TestCases.BaseClass;
...
public class ExtentReport extends BaseClass implements ITestListener {
    ...
    public void onStart(ITestContext testContext) {
        ...
        sparkReporter.config().setDocumentTitle("P360 Report");
        sparkReporter.config().setReportName("P360 UI Testing Report");
        sparkReporter.config().setTheme(Theme.DARK);

        extentReports = new ExtentReports();
        extentReports.attachReporter(sparkReporter);
        extentReports.setSystemInfo("Applcation name", "P360");
